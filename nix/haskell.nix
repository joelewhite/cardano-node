...
let
  ...
  projectPackages = import ./project-packages.nix;
  projectPackageNames = builtins.attrNames projectPackages;
...
haskell-nix.cabalProject' ({ pkgs
  ...
  modules =
    ...
    [
      ...
      ({ pkgs, ... }: {
        packages.tx-generator.package.buildable = with pkgs.stdenv.hostPlatform; isLinux && !isMusl;
      })
      {
